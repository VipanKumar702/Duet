const DUET_ICONS = {
  'shield-check': '<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1 1 0 0 1 1.52 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',
  ...
  'copy-check': '<rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/><path d="m9 14 2 2 4-4"/>',
...
function initIcons(root) {
  ...
  scope.querySelectorAll('[data-lucide]').forEach(el => {
    ...
    Array.from(el.classList).forEach(c => svg.classList.add(c));
    svg.innerHTML = body;
    el.replaceWith(svg);
  });
}